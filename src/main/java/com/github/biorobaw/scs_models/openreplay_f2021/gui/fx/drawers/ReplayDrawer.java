package com.github.biorobaw.scs_models.openreplay_f2021.gui.fx.drawers;
...
public class ReplayDrawer extends DrawerFX {
	 ...
	 */
	public ReplayDrawer(float[] pc_x, float[] pc_y, float[] values, int distance_option) {
		this.values = values;
	...
	public ReplayDrawer(float[] pc_x, float[] pc_y, float[] values) {
...
//		if (val<minValu e) val = 0;
		...
		return  Color.hsb(Color.RED.getHue(), 0, 0.8, alpha);
